...
def main():
    ...
    # top_passwords_permutators("list", top=10000, source_name="01_en_office_supplies.txt")
    # top_passwords_permutators("list", top=10000, source_name="02_en_office_brands.txt")
    # top_passwords_permutators("list", top=10000, source_name="03_keyboard_patterns.txt")
    # top_passwords_permutators("list", top=10000, source_name="05_en_financial_brands.txt")
    # top_passwords_permutators("list", top=10000, source_name="06_en_cities.txt")
    # top_passwords_permutators("list", top=10000, source_name="07_first_names.txt")
    # top_passwords_permutators("list", top=10000, source_name="08_last_names.txt")
    # top_passwords_permutators("list", top=10000, source_name="09_en_countries.txt")
    # top_passwords_permutators("list", top=10000, source_name="10_automobile.txt")
    # top_passwords_permutators("list", top=10000, source_name="11_software_names.txt")
    # top_passwords_permutators("list", top=10000, source_name="12_tech_brands.txt")
    # top_passwords_permutators("list", top=10000, source_name="13_en_fruit.txt")
    # top_passwords_permutators("list", top=10000, source_name="14_en_drinks.txt")
    # top_passwords_permutators("list", top=10000, source_name="15_en_food.txt")
    ...
    # top_passwords_permutators("dict", source_name="british-english", top=10000)
    # =============================================================================================================================================
    #
    ...
    # TODO Do we still need this since we now have a separate numbers class?
...
def top_passwords_permutators(source, source_name="", top=1000):
    ...
    if source == "list":
        aggregate_query = [
            {"$match": {"occurrences": {"$gt": 1}, "source": source_name}},
            {"$limit": top},
...
def topn_numbers(top):
    ...
    for k, v in enumerate(top_pws):
        labels.append(v["name"])
        occs.append(v["occurrences"])
        print(k+1, v["name"], helper.format_number(v["occurrences"]))
